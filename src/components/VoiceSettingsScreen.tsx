  ...
  return (
    <div className="h-full overflow-y-auto px-4 pb-4">
      ...
      <div className="glass-card rounded-2xl p-4 mb-4 bg-gradient-to-r from-cyan-neon/10 to-metallic-gold/5 border border-cyan-neon/20 animate-fade-in-up">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-text-muted">Mode dictée & casque Bluetooth</p>
          </div>
        </div>
      </div>
      ...
      <div className="glass-card rounded-2xl p-4 border border-white/10 animate-fade-in-up" style={{animationDelay: '200ms'}}>
        <h4 className="text-xs font-semibold text-white mb-3">Simulation de Lecture</h4>
        ...
        <div className="flex items-center justify-center gap-4 mb-3">
          {playbackState === 'idle' ? (
            <button
              ...
              className="w-14 h-14 rounded-full glass-button shadow-[0_0_25px_rgba(0,255,255,0.3)] flex items-center justify-center hover:scale-105 transition-transform"
            >
            ...
            <button
              ...
              className="w-14 h-14 rounded-full bg-red-500/20 border border-red-400/30 flex items-center justify-center hover:scale-105 transition-transform"
            >
